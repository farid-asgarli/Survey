...
public class SurveyCategoryTranslationConfiguration
    : IEntityTypeConfiguration<SurveyCategoryTranslation>
{
    public void Configure(EntityTypeBuilder<SurveyCategoryTranslation> builder)
    {
        builder.ToTable("survey_category_translations", DbSchemas.I18n);
        ...
        // Note: Relationship is configured in SurveyCategoryConfiguration (parent side)
