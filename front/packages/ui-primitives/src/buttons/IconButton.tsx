...
const iconButtonVariants = cva(
  'inline-flex items-center justify-center transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-surface disabled:pointer-events-none disabled:opacity-50 select-none active:scale-95',
  {
    variants: {
      variant: {
        // Standard - minimal, shows on hover
        standard: 'text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface focus-visible:ring-primary/30 rounded-full',
        ...
        'filled-tonal': 'bg-primary-container/70 text-on-primary-container hover:bg-primary-container focus-visible:ring-primary/30 rounded-full',
