 ...
 */
export const ALL_PRESETS: ValidationPreset[] = [
  ...PHONE_PRESETS,
  EMAIL_PRESET,
  ...URL_PRESETS,
  ...NUMBER_PRESETS,
    ...
    case "Email": {
      ...
      return {
        ...
        errorMessage: isValid
          ? undefined
          : settings?.validationMessage || "Please enter a valid email address",
      };
    }
    case "Phone": {
      ...
      return {
        ...
        errorMessage: isValid
          ? undefined
          : settings?.validationMessage || "Please enter a valid phone number",
      };
    }
    case "Url": {
      ...
      return {
        ...
        errorMessage: isValid
          ? undefined
          : settings?.validationMessage || "Please enter a valid URL",
      };
    }
    default:
      return { isValid: true };
