...
function Skeleton({ className, ref, ...props }: SkeletonProps) {
  return <div ref={ref} className={cn('animate-pulse rounded-2xl bg-surface-container-highest border border-outline-variant/30', className)} {...props} />;
}
...
function SkeletonCard({ className, ref, ...props }: SkeletonProps) {
  return (
    <div ref={ref} className={cn('rounded-3xl bg-[var(--color-card-idle)] border border-[var(--color-card-border)] p-6 space-y-4', className)} {...props}>
...
function SkeletonSurveyCard({ className, ref, ...props }: SkeletonProps) {
  return (
    <div ref={ref} className={cn('rounded-3xl bg-[var(--color-card-idle)] border border-[var(--color-card-border)] p-5 space-y-4', className)} {...props}>
