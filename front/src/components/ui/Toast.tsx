...
export const toast = {
  success: (title: string, options?: ToastOptions) => {
    return hotToast.custom(
      (t) => <CustomToast t={t} type='success' title={title} description={options?.description} action={options?.action} dismissLabel='Dismiss notification' />,
      {
  ...
  error: (title: string, options?: ToastOptions) => {
    return hotToast.custom(
      (t) => <CustomToast t={t} type='error' title={title} description={options?.description} action={options?.action} dismissLabel='Dismiss notification' />,
      {
  ...
  warning: (title: string, options?: ToastOptions) => {
    return hotToast.custom(
      (t) => <CustomToast t={t} type='warning' title={title} description={options?.description} action={options?.action} dismissLabel='Dismiss notification' />,
      {
        duration: options?.duration ?? 4000,
        position: 'bottom-left',
      }
  ...
  info: (title: string, options?: ToastOptions) => {
    return hotToast.custom(
      (t) => <CustomToast t={t} type='info' title={title} description={options?.description} action={options?.action} dismissLabel='Dismiss notification' />,
      {
        duration: options?.duration ?? 4000,
        position: 'bottom-left',
      }
