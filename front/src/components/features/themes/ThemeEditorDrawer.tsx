...
export function ThemeEditorDrawer({ open, onOpenChange, theme, onSave, isSaving = false }: ThemeEditorDrawerProps) {
  ...
  const initialFormData = useMemo((): ThemeFormData => {
    if (theme) {
      // Full SurveyTheme has non-nullable nested objects
      return {
        name: theme.name || '',
        ...
        progressBarStyle: theme.layout.progressBarStyle,
        showProgressBar: theme.layout.showProgressBar,
        ...
        logoSize: theme.branding.logoSize,
        showLogoBackground: theme.branding.showLogoBackground,
        ...
        backgroundImageUrl: theme.layout.backgroundImageUrl || '',
