...
import { Skeleton, LogoIcon } from '@/components/ui';
import { User, Shield, Palette, Bell, Key, Accessibility, Globe, LayoutDashboard, Hammer, ChevronRight, Info } from 'lucide-react';
...
function NavItem({ icon: Icon, label, description, isActive, onClick }: NavItemProps) {
  return (
    ...
    >
      <div className={cn('flex h-9 w-9 shrink-0 items-center justify-center rounded-lg transition-colors', isActive ? 'bg-white/20' : 'bg-surface-container')}>
