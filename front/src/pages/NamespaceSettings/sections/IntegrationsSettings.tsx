...
export function IntegrationsSettings({ namespaceId: _, isOwner }: IntegrationsSettingsProps) {
  ...
  // API keys will be fetched from backend when feature is implemented
        ...
        <CardContent>
          {apiKeys.length === 0 ? (
            ...
            <div className='space-y-3'>
              {apiKeys.map((key) => (
                <div key={key.id} className='flex items-center justify-between p-4 rounded-2xl bg-surface-container-low border border-outline-variant/20'>
