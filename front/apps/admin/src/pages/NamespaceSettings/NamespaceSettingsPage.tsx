...
import { BackButton, Tabs, TabsList, TabsTrigger, TabsContent, Skeleton, EmptyState } from '@/components/ui';
import { Building2, Settings, Users, CreditCard, Plug } from 'lucide-react';
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 md:p-6 border-b border-outline-variant/30">
          <div className="flex items-center gap-4">
            <BackButton onClick={() => navigate('/workspaces')} hideTooltip />
          </div>
