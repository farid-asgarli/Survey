    ...
    <Layout>
            ...
            {selectedSurveyId && (
              <div className='px-4 md:px-6 py-3 border-b border-outline-variant/30'>
                <div className='flex flex-wrap items-center gap-3'>
                  {/* Status Filters */}
                  <Tabs value={String(statusFilter)} onValueChange={(v) => setStatusFilter(v as StatusFilter)}>
                    <TabsList>
      ...
      <Drawer open={statsDrawer.isOpen} onOpenChange={statsDrawer.setOpen} side='right'>
        <DrawerContent className='max-w-2xl!'>
          ...
          <DrawerBody>
            {statsDrawer.selectedItem && selectedSurveyId && <DistributionStats surveyId={selectedSurveyId} distributionId={statsDrawer.selectedItem.id} />}
          </DrawerBody>
        </DrawerContent>
      </Drawer>
