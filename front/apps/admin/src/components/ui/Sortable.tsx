...
import { DndContext, DragOverlay, closestCenter, defaultDropAnimationSideEffects, MeasuringStrategy } from '@dnd-kit/core';
...
import type { UseSortableListReturn } from '@/hooks/useSortableList';
...
export interface SortableListProps<T> {
  /** Return value from useSortableList hook */
  sortable: UseSortableListReturn<T>;
