...
export function LongTextEditor({ question, onUpdateQuestion }: LongTextEditorProps) {
  ...
  return (
    <div className='space-y-6'>
      ...
      <Textarea
        ...
        helperText={t('questionEditor.common.shownInsideTextArea')}
        rows={2}
      />
      ...
      <Input
        ...
        value={question.settings.maxLength?.toString() || '2000'}
        onChange={(e) => onUpdateQuestion({ settings: { ...question.settings, maxLength: parseInt(e.target.value) || 2000 } })}
